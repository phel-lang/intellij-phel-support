...
object PhelFunctionRegistry {
    ...
    private val functions = mutableMapOf<String, List<DataFunction>>()
    ...
    fun getFunctions(namespace: String): List<DataFunction> {
